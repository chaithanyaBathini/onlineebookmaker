...
public class BookTest {
	...
	public void testCreateBook() throws InvalidUserException, TitleExistsException {
		...
		try {
			...
			res = null;
			Mockito.when(bookRepo.findByTitle(bookDto2.getTitle())).thenReturn(bookDto2.getTitle());
	...
	@Test
	public void testUpdateBook_Success() throws NoBookException {
		// arrange
		Long bookId = 1L;
		...
		assertEquals(updatedBookDto.getTitle(), existingBookEntity.getTitle());
		assertEquals(updatedBookDto.getContent(), existingBookEntity.getContent());
		assertEquals(updatedBookDto.getStatus(), existingBookEntity.getStatus());
		assertEquals(updatedBookDto.getStartDate(), existingBookEntity.getStartDate());
		assertEquals(updatedBookDto.getEndDate(), existingBookEntity.getEndDate());
	}

	@Test
	public void testUpdateBook_BookNotFound() throws NoBookException {
		// arrange
		Long bookId = 1L;
		when(bookRepo.findById(bookId)).thenReturn(Optional.of(existingBookEntity));
