...
public class EbookManageController {
	...
	public String createRequest(@PathVariable long bookId,@PathVariable String authorId,@Valid @RequestBody EbookManageDTO dto)throws DoesNotExistsException, NoBookException {
